...
class Node {
  ...
  std::vector<std::string> input_by_names_;
  std::vector<std::string> output_by_names_;
  ...
  public:
    ...
    name_(name), op_type_(op_type), input_by_names_(node_input) {}
    ...
    void push_back_output(Tensor* tensor) {output_.push_back(tensor);}

    std::string name() const {return name_;}
    std::string type() const {return op_type_;}
    size_t get_size_of_input() const  {return input_by_names_.size(); }
    size_t get_size_of_output() const {return output_by_names_.size();}

    std::string get_name_of_input(size_t index)  const {return input_by_names_[index];}
    std::string get_name_of_output(size_t index) const {return output_by_names_[index];}
    
    std::vector<std::string>    inputs_by_names()  const {return input_by_names_;}
    std::vector<std::string>    outputs_by_names() const {return output_by_names_;}
